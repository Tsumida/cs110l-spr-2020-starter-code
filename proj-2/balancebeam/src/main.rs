...
/// # Steps
/// 1. Choose an upstream server and build TCP connection.
/// 2. Client -> Proxy -> Upstream server.
/// 3. Upstream server -> Proxy -> Clinet.
/// 4. Close connection Client -> Proxy &  Upstream server -> Proxy.
///
